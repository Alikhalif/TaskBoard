...
<body>
                            ...
                            <div class="myBoxs" id="<?= $pro['idW'] ?>">
                                ...
                                <div class="overlay">
                                    <span class="content">
                                        ...
                                        <a href="#" id="updateWork" data-role="update" data-id="<?= $d['idW']; ?>"><i aria-hidden="true" class="fa fa-pencil"></i></a>
    ...
    <script>
        let btnUpt = document.querySelectorAll("#updateWork");
            btnUpt.forEach(work =>{
            ...
            document.querySelector("#updateWork").addEventListener("click", function(){
                document.querySelector(".popup-update").classList.add("active");
            });
    ...
    <script>
         $(document).on('click', '#updateWork', (e)=>{
                var id = parseInt(e.target.parent().parent().parent().id);
                // var taskdesc = $

                console.log(id);


                // var name = $('#' + id).parent().parent().parent().children().children().text();
                var description = $('#' + id).children().children('h3[data-target=title]').text();
