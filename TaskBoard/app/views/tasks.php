...
<body>
                    ...
                    <?php foreach($tasks as $task){ 
                        if($task['period'] == 'To do' ){ ?>
                            ...
                            <li draggable="true" class="box d-flex justify-content-between gap-2 mb-3 p-2 rounded-3">
                                ...
                                <input type="hidden" name="deadlinTsk" value="<?= $task['deadline'] ?>">

                                <span id="<?= $task['idT'] ?>">
                                    <a href="#" class="Update-Task" id="updateTask"><i aria-hidden="true" class="fa fa-pencil"></i></a>
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-2">
                    ...
                    <div class="card-body">
                        <!-- <form action="<?= BURL.'Home/AddTask' ?>" method="POST"> -->
                            ...
                            <input type="hidden" class="idTasksU">

                            <div class="form-floating ">
                                <input class="form-control tasknameU" name="taskname" type="text" placeholder="Add Task" />
                                <label>Task</label>
                            </div>
                            <div class="form-floating ">
                                <input class="form-control deadlinU" name="deadlin" type="date" placeholder="Add Task" />
                                <label>Deadline</label>
                            </div>
                            <div class="form-floating ">
                                <select class="form-control periodU" name="list-period" id="myselect">
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid"><button type="submit" name="btnUpdateTask" class="btn btn-primary btnUpdateTask">Add</button></div>
                            </div>
                        <!-- </form> -->
                    </div>
                </div>
    ...
    <script src="/assets/js/updateT.js"></script>
